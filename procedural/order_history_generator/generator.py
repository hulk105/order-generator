...
def generate_orders_history(data: dict, result_list: list):
    ...
    def get_zone_initial_date(zone):
        creation_date = datetime.datetime.strptime(data[ZONES][zone][INITIAL_DATE], const.DEFAULT_DATE_FORMAT)
        return creation_date

    def get_zone_end_date(zone):
        end_date = datetime.datetime.strptime(data[ZONES][zone][END_DATE], const.DEFAULT_DATE_FORMAT)
        return end_date
    ...
    def generate_order_dynamic_section(zone, date: datetime):
